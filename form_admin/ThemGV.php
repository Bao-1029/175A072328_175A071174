                        ...
                        <form action="" method="post" class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="username">Id Giảng Viên<span
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="tencb">Họ GV<span
                                            class="required">*</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="tencb">Tên GV<span
                                            class="required">*</span></label>
                                    <div class="col-md-8">
                                        <input id="tencb" name="tencb" type="text" class="form-control" required="">
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="tencb">Địa Chỉ<span
                                            class="required">*</span></label>
                                    <div class="col-md-8">
                                        <input id="tencb" name="tencb" type="text" class="form-control" required="">
                                    </div>
