                        ...
                        <form action="" method="post" class="form-horizontal form-label-left">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="username">Id Sinh Viên<span class="required">*</span></label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="tencb">CMT<span class="required">*</span></label>
                                    <div class="col-md-8">
                                        <input id="tencb" name="tencb" type="text" class="form-control" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="tencb">Lớp<span class="required">*</span></label>
                                    <div class="col-md-8">
                                        <input id="tencb" name="tencb" type="text" class="form-control" required="">
                                    </div>
                                </div>
